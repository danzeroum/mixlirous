...
pub enum LufsGainOutcome {
    /// Ganho aplicado; `gain_db` é o quanto foi ajustado e `limited_samples`
    /// (#37) conta quantas amostras excederam ±1.0 após a aplicação do ganho
    /// — permite ao chamador decidir se emite aviso ou corrige com o limiter.
    Applied {
        gain_db: f32,
